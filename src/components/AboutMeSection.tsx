...
const AboutMeSection: React.FC = () => {
    ...
    return (
        <>
            <div className='relative w-full h-[700px] flex items-center justify-center gap-10 dark:bg-[#00072d]' id='about'>
                <Particles
                ...
                <div className='flex flex-col gap-5 items-center justify-center px-2 max-[768px]:px-5'>
                    <TextAnimate animation="blurInUp" by="character" className='font-literata font-bold text-blue-500 dark:text-blue-600 text-6xl tracking-tight leading-tight max-[768px]:text-5xl max-[375px]:text-4xl'>About Me</TextAnimate>
                    <motion.p
                        initial={{ opacity: 0, filter: "blur(10px)", y: 20 }}
                        whileInView={{ opacity: 1, y: 0, filter: "blur(0px)" }}
                        transition={{ ease: "easeIn", delay: 0.2 }}
                        className='max-w-3xl font-montserrat font-medium text-center text-2xl text-slate-400 dark:text-slate-300 break-keep max-[768px]:text-base'>
