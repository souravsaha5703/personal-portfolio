            ...
            <Card className={"w-[350px] flex flex-col overflow-hidden border hover:shadow-lg transition-all duration-300 ease-out h-full"}>
                ...
                <CardHeader className="px-3">
                    <div>
                        ...
                        <p className="text-base leading-snug font-montserrat text-slate-950">
                            {desc}
                        </p>
                    </div>
                </CardHeader>
                ...
                <CardFooter className="px-2 pb-2 gap-2">
                    <Link to={link} target="_blank">
                        <Badge className="flex gap-2 px-2 py-1 text-sm">
                            <CiGlobe className='text-base text-slate-100' />
                            Website
                        </Badge>
                    </Link>
                    <Link to={githubLink} target="_blank">
                        <Badge className="flex gap-2 px-2 py-1 text-sm">
                            <IoLogoGithub className='text-base text-slate-100' />
                            Github
                        </Badge>
                    </Link>
                </CardFooter>
